        ...
        <div className="flex w-full items-center justify-between">
          <div className="grow">
            ...
            <Link
              ...
              className="inline-block w-full rounded-4xl bg-white py-4 text-center typo-13-medium text-primary-700 md:w-86.5"
            >
              지금 바로 체험 보러 가기
            </Link>
          </div>
          <Logo variant="white" className="hidden w-63 lg:block" />
        </div>
