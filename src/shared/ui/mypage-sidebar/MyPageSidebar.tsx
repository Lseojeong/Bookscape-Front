...
export default function MyPageSidebar({ user }: MyPageSidebarProps) {
  return (
    <>
      <aside className="sticky top-0 hidden h-full w-44.5 shrink-0 rounded-xl border border-gray-50 bg-white px-3.5 py-4 shadow-drop sm:block lg:w-72.5 lg:py-6">
