...
export default function MyPageSidebar({ user }: MyPageSidebarProps) {
  return (
    <>
      <aside className="sticky hidden h-fit w-44.5 shrink-0 rounded-xl border border-gray-50 bg-white px-3.5 py-4 shadow-drop sm:top-22 sm:block md:top-30 lg:w-72.5 lg:py-6">
      ...
      <div className="sticky top-12 mb-6 bg-white pt-3 sm:hidden">
