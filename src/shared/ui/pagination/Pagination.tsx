...
export default function Pagination({
  ...
  const isPrevDisabled = currentPage === 1; // 이전 페이지 버튼 비활성화 여부 (현재 페이지가 1이면 버튼 비활성화)
  const isNextDisabled = currentPage === totalPages; // 다음 페이지 버튼 비활성화 여부 (현재 페이지가 마지막 페이지이면 버튼 비활성화)
